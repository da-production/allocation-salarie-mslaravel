...
Route::group(['middleware' => config('fortify.middleware', ['web'])], function () {
    ...
    if (Features::enabled(Features::registration())) {
        if ($enableViews) {
            Route::get('/inscription/etape/1', [RegisteredUserController::class, 'create'])
                ->middleware(['guest:' . config('fortify.guard')])
                ->name('inscription');
        }

        Route::post('/inscription/etape/1', [RegisteredUserController::class, 'store'])
            ->middleware(['guest:' . config('fortify.guard')]);
    }


    Route::get('/inscription/etape/2', 'SalarieController@inscription2')
        ->middleware('InscriptionEtapeDeux')
        ->name('inscription.etape2');
    Route::post('/inscription', 'SalarieController@store')
        ->middleware(['InscriptionEtapeDeux'])
        ->name('inscription.etape2.store');
