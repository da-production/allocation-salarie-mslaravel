...
@endif 
  <form action="{{ route('inscription') }}" method="post">
    ...
    <div class="form-floating">
      <input type="text" name="code_wilaya" class="form-control" id="floatingInput" placeholder="name@example.com">
      <label for="floatingInput">Code Wilaya</label>
      @error('code_wilaya')
          {{ $message }}
      @enderror
    </div>
    <div class="form-floating">
        <input type="text" name="code_employeur" class="form-control" id="floatingInput" placeholder="name@example.com">
        <label for="floatingInput">Code Employeur</label>
