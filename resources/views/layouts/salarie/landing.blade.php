...
<head>
    ...
    <title>CNAC | {{ config('app.name') }} {{ "| " . $pagetitle ?? "|" }}</title>
...
<body>
    ...
    <div class=" col-12 p-4 text-center rounded">
        ...
        <h5><b>au profit des salaries</b></h5>
    </div>
        ...
        <div class="container">
            ...
            <div id="navigation" class="active">
                ...
                <ul class="navigation-menu">
                    ...
                    @if(Auth::check())
                        <li class="active">
                            @can('navmenu-title', App\Models\User::class)
                                <a href="{{ route('salarie.profile') }}">Mon Espace</a>
                            @endcan
                            @cannot('navmenu-title', App\Models\User::class)
                                <a href="{{ route('inscription.etape2') }}">Etape (2)</a>
                            @endcan
                        </li>
                        <li class="active">
                    ...
                    @else
                        <li class="active"><a href="{{ route('connexion') }}">s'Identifier</a></li>
                    @endif
    ...
    <footer >
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="">
                        <p class="mb-0">© {{ Date('Y') }} - {{ config('app.name') }} - v{{ config('app.version') }} - Developped by {{ config('app.team') }}. <a href="https://www.cnac.dz">www.cnac.dz</a></p>
                    </div>
                </div>
            </div>
        </div>
