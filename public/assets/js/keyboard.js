...
function VKI_buildKeyboardInputs() {
        ...
        if (elem) {
            for (var y = 0, keyid = "", ex; (ex = elem[y++]); ) {
                if (
                    ...
                    keybut.src =
                        "http://www.arabic-keyboard.org/keyboard/keyboard.png";
    ...
    label.appendChild(
        document.createTextNode(
            " Dead keys: " + (checkbox.checked ? "On" : "Off")
        )
    );
    ...
    this.VKI_buildKeys = function () {
        this.VKI_shift =
            ...
            this.VKI_dead =
                false;
        this.VKI_deadkeysOn = this.VKI_layoutDDK[this.VKI_kt]
            ? false
            : this.VKI_keyboard.getElementsByTagName(
                  "label"
              )[0].getElementsByTagName("input")[0].checked;

        var container =
            this.VKI_keyboard.tBodies[0].getElementsByTagName("div")[0];
                    ...
                    default:
                        td.onclick = function () {
                            if (self.VKI_deadkeysOn && self.VKI_dead) {
                                if (
                                    self.VKI_dead != this.firstChild.nodeValue
                                ) {
        ...
        this.VKI_keyboard.getElementsByTagName("label")[0].style.display =
            hasDeadKey ? "inline" : "none";
    };
                    ...
                    default:
                        if (type)
                            tds[y].firstChild.nodeValue =
                                lkey[
                                    vchar +
                                        (this.VKI_alternate && lkey.length == 4
                                            ? 2
                                            : 0)
                                ];
                        if (this.VKI_deadkeysOn) {
                            ...
                            if (this.VKI_dead) {
                                ...
                                for (
                                    ...
                                    if (
                                        char ==
                                        this.VKI_deadkey[this.VKI_dead][z][0]
                                    ) {
                                        target = true;
                                        break;
                                    }
            ...
            if (this.VKI_visible != id) {
                ...
                this.VKI_keyboard.style.top =
                    ...
                    this.VKI_keyboard.style.left =
                        "auto";
                this.VKI_keyboard.style.position =
    ...
    this.VKI_position = function () {
        if (self.VKI_visible != "") {
            ...
            self.VKI_keyboard.style.left =
                Math.min(
                    VKI_innerDimensions()[0] -
                        self.VKI_keyboard.offsetWidth -
                        15,
                    inputElemPos[0]
                ) + "px";
        }
